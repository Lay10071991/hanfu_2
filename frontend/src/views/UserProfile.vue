        ...
        <div class="profile-layout">
          ...
          <div class="content">
            ...
            <div v-else-if="activeMenu === 'activity-registrations'" class="section">
                  ...
                  <div class="registration-content">
                    ...
                    <div class="registration-details">
                      <div class="registration-meta">
                        <span class="registration-date">报名时间：{{ registration.registrationDate }}</span>
                        <div class="registration-actions">
                          <el-button
                            v-if="registration.status === 'registered' || registration.status === 'upcoming'"
                            type="danger"
                            size="small"
              ...
              <el-empty v-if="filteredRegistrations.length === 0" :description="getEmptyDescription()" />
            </div>
...
onMounted(() => {
  ...
  if (savedUsername) {
    ...
    editForm.username = savedUsername
  }
  if (savedGender) {
    userInfo.value.gender = savedGender
    editForm.gender = savedGender
  }
  if (savedBio) {
    userInfo.value.bio = savedBio
    editForm.bio = savedBio
  }
})
...
const saveProfile = () => {
  ...
  localStorage.setItem('gender', editForm.gender)
...
.evaluations-list, .posts-list, .likes-list {
  display: flex;
  flex-direction: column;
  gap: 15px;
}

.evaluation-item, .post-item, .like-item {
  padding: 15px;
