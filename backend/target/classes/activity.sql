...
CREATE TABLE `user`  (
  ...
  `bio` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '简介',
...
CREATE TABLE `cultural_content`  (
  ...
  `years` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '年代',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `cultural_content` VALUES (1, '汉服的历史概述', '汉服历史', '汉服，全称是"汉民族传统服饰"，又称汉衣冠、汉装、华服，是从黄帝即位到公元17世纪中叶(明末清初)，在汉族的主要居住区，以"华夏-汉"文化为背景和主导思想，以华夏礼仪文化为中心，通过自然演化而形成的具有独特汉民族风貌性格，明显区别于其他民族的传统服装和配饰体系。', 'overview', '黄帝时期至明末清初');
...
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '汉服图片表' ROW_FORMAT = Dynamic;
...
-- Records of festival
-- ----------------------------
INSERT INTO `festival` VALUES (1, '成人礼', '农历三月三', 'spring', '/uploads/festival_custom/1.jpg', '古代重要的成年仪式，男子二十岁行冠礼，女子十五岁行笄礼，标志正式成年，承担社会责任。', '加冠:男子二十岁时举行冠礼，加冠三次，象征成年，获得社会认可|及笄:女子十五岁时举行笄礼，将头发盘起，标志成年，可以婚嫁|取字:成年后取字，用于社交场合，体现文化修养');
INSERT INTO `festival` VALUES (2, '上元节', '农历正月十五', 'spring', '/uploads/festival_custom/2.jpg', '新年第一个月圆之夜，赏灯猜谜，祈求新的一年平安顺利。', '赏花灯:各地举办灯会，展示各种精美的花灯造型|猜灯谜:将谜语写在灯笼上，供人猜射，增添节日趣味|吃元宵:食用糯米制成的圆形食品，象征团圆美满');
INSERT INTO `festival` VALUES (3, '乞巧节', '农历七月初七', 'summer', '/uploads/festival_custom/3.jpg', '中国的情人节，源于牛郎织女的传说，女子乞巧祈福。', '乞巧:女子向织女星祈求智巧，提高女红技艺|观星:夜晚仰望星空，寻找牛郎织女星|祈福:祈求美好姻缘和幸福生活');
INSERT INTO `festival` VALUES (4, '清明节', '公历四月四-六日', 'spring', '/uploads/festival_custom/4.jpg', '祭祖扫墓，缅怀先人，同时也是踏青郊游的好时节。', '扫墓祭祖:清理祖先墓地，献上祭品，表达对先人的怀念|踏青郊游:春光明媚时节，外出游玩，感受大自然|放风筝:放飞风筝，寓意放走晦气，迎接好运');
INSERT INTO `festival` VALUES (5, '端午节', '农历五月初五', 'summer', '/uploads/festival_custom/5.jpg', '纪念屈原的节日，有赛龙舟、吃粽子的习俗，驱邪避疫。', '赛龙舟:多人划桨竞赛，纪念屈原投江，体现团结协作精神|吃粽子:用糯米包裹各种馅料，纪念屈原，也是时令美食|挂艾草:悬挂艾草和菖蒲，驱除蚊虫，净化空气');
INSERT INTO `festival` VALUES (6, '中秋节', '农历八月十五', 'autumn', '/uploads/festival_custom/6.jpg', '月圆人团圆，赏月吃月饼，寄托思念之情。', '赏月:家人团聚，欣赏圆月，寄托思念之情|吃月饼:食用圆形月饼，象征团圆美满|祭月:设香案祭拜月神，祈求平安吉祥');
INSERT INTO `festival` VALUES (7, '重阳节', '农历九月初九', 'autumn', '/uploads/festival_custom/7.jpg', '敬老爱老的节日，登高赏菊，祈求健康长寿。', '登高:登山远眺，锻炼身体，祈求避灾|赏菊:欣赏菊花，饮酒赋诗，陶冶情操|敬老:慰问老人，表达对长者的尊敬和关爱');
INSERT INTO `festival` VALUES (8, '冬至节', '公历十二月二十一-二十三日', 'winter', '/uploads/festival_custom/8.jpg', '一年中白昼最短的一天，北方吃饺子，南方吃汤圆。', '吃饺子:北方习俗，吃饺子寓意不冻耳朵|吃汤圆:南方习俗，吃汤圆象征团圆|祭祖:祭祀祖先，表达对先人的怀念');
INSERT INTO `festival` VALUES (9, '腊八节', '农历腊月初八', 'winter', '/uploads/festival_custom/9.jpg', '佛教节日，喝腊八粥，祈求平安吉祥。', '喝腊八粥:用多种食材熬制粥品，祈求五谷丰登|祭祀:祭祀祖先和神灵，祈求来年平安|施粥:向穷人施粥，体现慈悲心肠');
...
CREATE TABLE `festival_activity`  (
  ...
  `title` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '活动标题',
  `season` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '所属季节(spring/summer/autumn/winter)',
  `date` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '活动日期',
  `location` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '活动地点',
...
-- ----------------------------
INSERT INTO `festival_activity` VALUES (1, '上元节灯会', 'spring', '2026年2月12日', '北京故宫', '/uploads/festival_gathering/1.jpg', '上元节，又称元宵节，是新年第一个月圆之夜。本次活动将在故宫举办盛大的灯会，展示各种精美的花灯造型，参与者可以猜灯谜、吃元宵，感受传统节日的魅力。', '猜灯谜：活动现场设置各类灯谜，参与者可凭智慧赢取精美奖品。赏花灯：欣赏各种传统花灯造型。吃元宵：品尝各种口味的传统元宵。穿汉服：鼓励参与者身着汉服参加。', '请提前在官方平台预约门票，活动期间人流量较大。建议穿着舒适的鞋子，活动场地较大需要步行。夜间气温较低，请注意保暖。', '2026-01-01 00:00:00', '2026-01-01 00:00:00');
INSERT INTO `festival_activity` VALUES (2, '清明踏青雅集', 'spring', '2026年4月4日', '杭州西湖', '/uploads/festival_gathering/2.jpg', '清明时节，春光明媚。本次活动将在西湖边举行踏青雅集，参与者可以身着汉服，漫步苏堤春晓，放风筝，品尝清明团子，感受春日的美好。', '踏青赏花：漫步西湖苏堤，欣赏春日美景。放风筝：在指定区域放飞传统风筝。品尝青团：品尝清明传统美食青团。插柳戴柳：学习清明插柳戴柳的传统习俗。', '请穿着适合户外活动的服装和鞋子。春季天气多变，建议携带雨具和外套。注意防晒，建议携带遮阳帽和防晒霜。', '2026-01-02 00:00:00', '2026-01-02 00:00:00');
INSERT INTO `festival_activity` VALUES (3, '端午龙舟竞渡', 'summer', '2026年6月19日', '苏州金鸡湖', '/uploads/festival_gathering/3.jpg', '端午节是纪念屈原的传统节日。本次活动将在金鸡湖举办龙舟竞渡，参与者可以体验划龙舟的乐趣，品尝各种口味的粽子，学习包粽子的技艺。', '龙舟竞渡：观看或参与龙舟比赛，体验团队协作的乐趣。包粽子：学习传统包粽子技艺。佩香囊：制作和佩戴端午香囊。挂艾草：学习端午挂艾草、菖蒲的传统习俗。', '夏季户外活动请注意防暑降温，及时补充水分。参与水上活动请听从工作人员安排，注意安全。建议穿着轻便透气的服装和防滑鞋。', '2026-01-03 00:00:00', '2026-01-03 00:00:00');
INSERT INTO `festival_activity` VALUES (4, '七夕乞巧大会', 'summer', '2026年8月19日', '西安大唐芙蓉园', '/uploads/festival_gathering/4.jpg', '七夕节是中国的情人节，源于牛郎织女的美丽传说。本次活动将在大唐芙蓉园举办乞巧大会，参与者可以学习传统女红技艺，祈求美好姻缘。', '穿针乞巧：体验传统乞巧习俗，比赛穿针引线。女红体验：学习刺绣、编织等传统女红技艺。拜织女：了解七夕拜织女的传统仪式。放河灯：在芙蓉园水域放河灯。', '活动场地为户外，夏季请注意防暑降温。建议穿着汉服或传统服饰参加活动，增强氛围感。夜间活动请注意安全，听从工作人员指引。', '2026-01-04 00:00:00', '2026-01-04 00:00:00');
INSERT INTO `festival_activity` VALUES (5, '中秋赏月诗会', 'autumn', '2026年9月24日', '南京夫子庙', '/uploads/festival_gathering/5.jpg', '中秋节是月圆人团圆的美好时刻。本次活动将在夫子庙举办赏月诗会，参与者可以品尝各种口味的月饼，吟诗作对，欣赏秦淮河的月色。', '赏月吟诗：在秦淮河畔赏月，参与诗词接龙和即兴创作。品尝月饼：品尝苏式、广式等各种风味的传统月饼。拜月仪式：了解和学习传统中秋拜月仪式。', '秋季夜晚气温较低，请注意保暖，建议携带外套。活动涉及水域，请注意安全，不要靠近水边。请遵守现场秩序，文明参与活动。', '2026-01-05 00:00:00', '2026-01-05 00:00:00');
INSERT INTO `festival_activity` VALUES (6, '重阳登高敬老', 'autumn', '2026年10月11日', '泰山', '/uploads/festival_gathering/6.jpg', '重阳节是敬老爱老的传统节日。本次活动将组织登泰山活动，参与者可以欣赏秋日的壮丽景色，品尝菊花酒，表达对长者的尊敬和关爱。', '登高望远：登泰山赏秋景，体验重阳登高的传统习俗。敬老活动：参与敬老爱老活动，向长者表达敬意。赏菊品酒：品尝菊花酒，欣赏各种菊花品种。', '登山活动请根据自身身体状况量力而行。请穿着舒适的运动鞋和适合登山的服装。秋季山顶气温较低，请携带保暖衣物。', '2026-01-06 00:00:00', '2026-01-06 00:00:00');
INSERT INTO `festival_activity` VALUES (7, '冬至饺子宴', 'winter', '2026年12月21日', '北京四合院', '/uploads/festival_gathering/7.jpg', '冬至是一年中白昼最短的一天。本次活动将在传统四合院举办饺子宴，参与者可以学习包饺子的技艺，了解冬至的传统习俗，感受冬日的温暖。', '包饺子：学习传统包饺子技艺，了解不同馅料的寓意。吃饺子：品尝各种口味的饺子。数九消寒：了解冬至数九习俗，制作九九消寒图。', '冬季户外活动请注意保暖，穿着厚实的冬装。四合院室内外温差较大，请注意增减衣物。如有食物过敏请提前告知工作人员。', '2026-01-07 00:00:00', '2026-01-07 00:00:00');
INSERT INTO `festival_activity` VALUES (8, '腊八施粥祈福', 'winter', '2027年1月17日', '杭州灵隐寺', '/uploads/festival_gathering/8.jpg', '腊八节是佛教重要节日。本次活动将在灵隐寺举办施粥祈福活动，参与者可以品尝用多种食材熬制的腊八粥，祈求来年平安吉祥。', '品尝腊八粥：品尝用多种食材熬制的传统腊八粥。祈福许愿：在寺庙内祈福许愿。了解佛文化：参观寺庙，了解腊八节的佛教文化内涵。', '进入寺庙请保持安静，尊重佛教礼仪。冬季山区气温较低，请注意保暖。请穿着端庄得体的服装，不宜过于暴露。', '2026-01-08 00:00:00', '2026-01-08 00:00:00');
INSERT INTO `festival_activity` VALUES (9, '成人礼仪式', 'spring', '2026年3月21日', '曲阜孔庙', '/uploads/festival_gathering/9.jpg', '成人礼是古代重要的成年仪式。本次活动将在孔庙举办传统成人礼，男子行冠礼，女子行笄礼，标志正式成年，承担社会责任，传承中华礼仪文化。', '冠礼仪式：男子行冠礼，三加冠服，象征成年。笄礼仪式：女子行笄礼，加笄换装。聆训受教：聆听长辈训诫，接受成人责任。', '请穿着正式汉服参加仪式，建议提前准备。仪式庄重，请保持肃静，手机调至静音。请提前到达，熟悉仪式流程和站位。', '2026-01-09 00:00:00', '2026-01-09 00:00:00');
...
INSERT INTO `festival_activity_comment` VALUES (1, 1, 'lay', '故宫的灯会太美了！各种花灯造型精美绝伦，猜灯谜也很有趣。');
INSERT INTO `festival_activity_comment` VALUES (2, 1, 'Echo', '第一次穿汉服参加灯会，氛围感满满，明年一定还要来！');
INSERT INTO `festival_activity_comment` VALUES (3, 1, '挽墨', '元宵特别甜，和同袍们一起赏灯的感觉真好。');
INSERT INTO `festival_activity_comment` VALUES (4, 1, '星河滚烫', '故宫夜景配上汉服和花灯，像穿越回古代一样。');
INSERT INTO `festival_activity_comment` VALUES (5, 1, '清风徐来', '灯谜很有意思，还赢了不少小礼品，开心！');
INSERT INTO `festival_activity_comment` VALUES (6, 1, '北岛信物', '人有点多，但氛围真的很好，传统文化活动要多举办。');
INSERT INTO `festival_activity_comment` VALUES (7, 1, '橘子汽水', '拍了很多照片，每一张都是大片，太喜欢了！');
INSERT INTO `festival_activity_comment` VALUES (8, 1, '半糖主义', '汉服配花灯真的绝美，下次要带朋友一起来。');
INSERT INTO `festival_activity_comment` VALUES (9, 1, '月亮邮递员', '传统节日就该这样过，有仪式感又有文化内涵。');
INSERT INTO `festival_activity_comment` VALUES (10, 1, 'Wanderer', '故宫的夜景真的太震撼了，花灯设计得很用心。');
INSERT INTO `festival_activity_comment` VALUES (11, 1, 'Nostalgia', '猜灯谜环节特别有趣，学到了很多传统文化知识。');
INSERT INTO `festival_activity_comment` VALUES (12, 1, 'Paradox', '穿着汉服在故宫赏灯，感觉像穿越了一样。');
INSERT INTO `festival_activity_comment` VALUES (13, 1, 'Serendipity', '元宵节的活动办得真好，期待明年的灯会！');
INSERT INTO `festival_activity_comment` VALUES (14, 1, '寄风给你', '和同袍们一起过节的感觉太棒了，认识了很多新朋友。');
INSERT INTO `festival_activity_comment` VALUES (15, 1, '且听风吟', '花灯的造型太精致了，每个都想拍照留念。');
INSERT INTO `festival_activity_comment` VALUES (16, 1, '温柔半两', '传统节日的氛围感拉满，这才是过年的感觉。');
INSERT INTO `festival_activity_comment` VALUES (17, 1, '晚风吻尽', '明年元宵节一定还要来，太喜欢这种氛围了！');

-- 节庆活动9(成人礼仪式)的17条评论 - 活动已结束
INSERT INTO `festival_activity_comment` VALUES (18, 9, 'lay', '在孔庙参加成人礼太有仪式感了，终生难忘的经历！');
INSERT INTO `festival_activity_comment` VALUES (19, 9, 'Nostalgia', '冠礼和笄礼的仪式很庄重，感受到了成年的责任。');
INSERT INTO `festival_activity_comment` VALUES (20, 9, 'Paradox', '曲阜孔庙的氛围特别好，礼仪老师讲解得很细致。');
INSERT INTO `festival_activity_comment` VALUES (21, 9, 'Serendipity', '第一次参加传统成人礼，比西式成人礼有意义多了。');
INSERT INTO `festival_activity_comment` VALUES (22, 9, '寄风给你', '穿着汉服行成人礼，感觉真正长大了，要承担责任了。');
INSERT INTO `festival_activity_comment` VALUES (23, 9, '且听风吟', '仪式感满满，传统文化需要这样的传承方式。');
INSERT INTO `festival_activity_comment` VALUES (24, 9, '温柔半两', '父母在台下看着我行礼，那一刻真的很感动。');
INSERT INTO `festival_activity_comment` VALUES (25, 9, '晚风吻尽', '希望以后能有更多年轻人参与传统成人礼。');
INSERT INTO `festival_activity_comment` VALUES (26, 9, 'Echo', '孔庙的环境很庄严，让整个仪式更有意义。');
INSERT INTO `festival_activity_comment` VALUES (27, 9, '挽墨', '礼仪老师很专业，每个步骤都讲解得很清楚。');
INSERT INTO `festival_activity_comment` VALUES (28, 9, '星河滚烫', '成人礼让我真正理解了成长的意义。');
INSERT INTO `festival_activity_comment` VALUES (29, 9, '清风徐来', '传统礼仪文化需要传承，这样的活动很有价值。');
INSERT INTO `festival_activity_comment` VALUES (30, 9, '北岛信物', '穿着汉服行礼的感觉很特别，终生难忘。');
INSERT INTO `festival_activity_comment` VALUES (31, 9, '橘子汽水', '仪式后和同袍们合影留念，记录下这重要的时刻。');
INSERT INTO `festival_activity_comment` VALUES (32, 9, '半糖主义', '感谢主办方，让我有了一次难忘的成人礼体验。');
INSERT INTO `festival_activity_comment` VALUES (33, 9, '月亮邮递员', '传统文化活动办得越来越好，支持！');
INSERT INTO `festival_activity_comment` VALUES (34, 9, '落日飞车', '以后有类似活动一定还会参加。');
...
CREATE TABLE `festival_activity_registration`  (
  ...
  `registration_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '报名时间',
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `festival_activity_registration` VALUES (1, 1, 2, 'registered', '2025-10-15 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (2, 1, 4, 'registered', '2025-10-15 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (3, 1, 5, 'registered', '2025-10-16 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (4, 1, 6, 'registered', '2025-10-17 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (5, 1, 7, 'registered', '2025-10-18 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (6, 1, 8, 'registered', '2025-10-20 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (7, 1, 9, 'registered', '2025-10-21 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (8, 1, 10, 'registered', '2025-10-22 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (9, 1, 22, 'registered', '2025-10-23 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (10, 1, 23, 'registered', '2025-10-24 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (11, 1, 24, 'registered', '2025-10-25 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (12, 1, 25, 'registered', '2025-10-26 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (13, 1, 26, 'registered', '2025-10-27 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (14, 1, 27, 'registered', '2025-10-28 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (15, 1, 28, 'registered', '2025-10-29 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (16, 1, 29, 'registered', '2025-10-30 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (17, 1, 30, 'registered', '2025-10-31 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (18, 1, 31, 'registered', '2025-11-01 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (19, 1, 32, 'registered', '2025-11-02 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (20, 1, 33, 'registered', '2025-11-03 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (21, 1, 34, 'registered', '2025-11-04 09:00:00');

-- 节庆活动2(清明踏青雅集)的19条报名记录
INSERT INTO `festival_activity_registration` VALUES (22, 2, 4, 'registered', '2025-11-10 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (23, 2, 5, 'registered', '2025-11-11 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (24, 2, 6, 'registered', '2025-11-12 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (25, 2, 7, 'registered', '2025-11-13 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (26, 2, 8, 'registered', '2025-11-14 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (27, 2, 9, 'registered', '2025-11-15 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (28, 2, 10, 'registered', '2025-11-16 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (29, 2, 22, 'registered', '2025-11-17 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (30, 2, 23, 'registered', '2025-11-18 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (31, 2, 24, 'registered', '2025-11-19 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (32, 2, 25, 'registered', '2025-11-20 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (33, 2, 26, 'registered', '2025-11-21 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (34, 2, 27, 'registered', '2025-11-22 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (35, 2, 28, 'registered', '2025-11-23 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (36, 2, 29, 'registered', '2025-11-24 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (37, 2, 30, 'registered', '2025-11-25 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (38, 2, 31, 'registered', '2025-11-26 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (39, 2, 32, 'registered', '2025-11-27 14:30:00');

-- 节庆活动3(端午龙舟竞渡)的24条报名记录，包含lay(id=2)
INSERT INTO `festival_activity_registration` VALUES (40, 3, 2, 'registered', '2025-11-28 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (41, 3, 4, 'registered', '2025-11-29 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (42, 3, 5, 'registered', '2025-11-30 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (43, 3, 6, 'registered', '2025-12-01 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (44, 3, 7, 'registered', '2025-12-02 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (45, 3, 8, 'registered', '2025-12-03 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (46, 3, 9, 'registered', '2025-12-04 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (47, 3, 10, 'registered', '2025-12-05 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (48, 3, 22, 'registered', '2025-12-06 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (49, 3, 23, 'registered', '2025-12-07 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (50, 3, 24, 'registered', '2025-12-08 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (51, 3, 25, 'registered', '2025-12-09 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (52, 3, 26, 'registered', '2025-12-10 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (53, 3, 27, 'registered', '2025-12-11 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (54, 3, 28, 'registered', '2025-12-12 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (55, 3, 29, 'registered', '2025-12-13 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (56, 3, 30, 'registered', '2025-12-14 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (57, 3, 31, 'registered', '2025-12-15 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (58, 3, 32, 'registered', '2025-12-16 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (59, 3, 33, 'registered', '2025-12-17 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (60, 3, 34, 'registered', '2025-12-18 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (61, 3, 35, 'registered', '2025-12-19 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (62, 3, 36, 'registered', '2025-12-20 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (63, 3, 37, 'registered', '2025-12-21 14:00:00');

-- 节庆活动4(七夕乞巧大会)的22条报名记录
INSERT INTO `festival_activity_registration` VALUES (64, 4, 4, 'registered', '2025-12-22 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (65, 4, 5, 'registered', '2025-12-23 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (66, 4, 6, 'registered', '2025-12-24 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (67, 4, 7, 'registered', '2025-12-25 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (68, 4, 8, 'registered', '2025-12-26 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (69, 4, 9, 'registered', '2025-12-27 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (70, 4, 10, 'registered', '2025-12-28 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (71, 4, 22, 'registered', '2025-12-29 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (72, 4, 23, 'registered', '2025-12-30 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (73, 4, 24, 'registered', '2025-12-31 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (74, 4, 25, 'registered', '2026-01-01 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (75, 4, 26, 'registered', '2026-01-02 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (76, 4, 27, 'registered', '2026-01-03 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (77, 4, 28, 'registered', '2026-01-04 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (78, 4, 29, 'registered', '2026-01-05 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (79, 4, 30, 'registered', '2026-01-06 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (80, 4, 31, 'registered', '2026-01-07 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (81, 4, 32, 'registered', '2026-01-08 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (82, 4, 33, 'registered', '2026-01-09 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (83, 4, 34, 'registered', '2026-01-10 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (84, 4, 35, 'registered', '2026-01-11 10:30:00');

-- 节庆活动5(中秋赏月诗会)的20条报名记录，包含lay(id=2)
INSERT INTO `festival_activity_registration` VALUES (85, 5, 2, 'registered', '2026-01-12 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (86, 5, 4, 'registered', '2026-01-13 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (87, 5, 5, 'registered', '2026-01-14 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (88, 5, 6, 'registered', '2026-01-15 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (89, 5, 7, 'registered', '2026-01-16 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (90, 5, 8, 'registered', '2026-01-17 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (91, 5, 9, 'registered', '2026-01-18 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (92, 5, 10, 'registered', '2026-01-19 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (93, 5, 22, 'registered', '2026-01-20 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (94, 5, 23, 'registered', '2026-01-21 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (95, 5, 24, 'registered', '2026-01-22 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (96, 5, 25, 'registered', '2026-01-23 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (97, 5, 26, 'registered', '2026-01-24 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (98, 5, 27, 'registered', '2026-01-25 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (99, 5, 28, 'registered', '2026-01-26 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (100, 5, 29, 'registered', '2026-01-27 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (101, 5, 30, 'registered', '2026-01-28 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (102, 5, 31, 'registered', '2026-01-29 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (103, 5, 32, 'registered', '2026-01-30 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (104, 5, 33, 'registered', '2026-01-31 16:00:00');

-- 节庆活动6(重阳登高敬老)的18条报名记录
INSERT INTO `festival_activity_registration` VALUES (105, 6, 4, 'registered', '2026-02-01 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (106, 6, 5, 'registered', '2026-02-02 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (107, 6, 6, 'registered', '2026-02-03 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (108, 6, 7, 'registered', '2026-02-04 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (109, 6, 8, 'registered', '2026-02-05 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (110, 6, 9, 'registered', '2026-02-06 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (111, 6, 10, 'registered', '2026-02-07 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (112, 6, 22, 'registered', '2026-02-08 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (113, 6, 23, 'registered', '2026-02-09 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (114, 6, 24, 'registered', '2026-02-10 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (115, 6, 25, 'registered', '2026-02-11 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (116, 6, 26, 'registered', '2026-02-12 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (117, 6, 27, 'registered', '2026-02-13 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (118, 6, 28, 'registered', '2026-02-14 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (119, 6, 29, 'registered', '2026-02-15 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (120, 6, 30, 'registered', '2026-02-16 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (121, 6, 31, 'registered', '2026-02-17 12:00:00');

-- 节庆活动7(冬至饺子宴)的17条报名记录
INSERT INTO `festival_activity_registration` VALUES (122, 7, 4, 'registered', '2026-02-18 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (123, 7, 5, 'registered', '2026-02-19 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (124, 7, 6, 'registered', '2026-02-20 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (125, 7, 7, 'registered', '2026-02-21 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (126, 7, 8, 'registered', '2026-02-22 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (127, 7, 9, 'registered', '2026-02-23 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (128, 7, 10, 'registered', '2026-02-24 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (129, 7, 22, 'registered', '2026-02-25 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (130, 7, 23, 'registered', '2026-02-26 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (131, 7, 24, 'registered', '2026-02-27 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (132, 7, 25, 'registered', '2026-02-28 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (133, 7, 26, 'registered', '2026-03-01 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (134, 7, 27, 'registered', '2026-03-02 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (135, 7, 28, 'registered', '2026-03-03 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (136, 7, 29, 'registered', '2026-03-04 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (137, 7, 30, 'registered', '2026-03-05 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (138, 7, 31, 'registered', '2026-03-06 10:45:00');

-- 节庆活动8(腊八施粥祈福)的19条报名记录
INSERT INTO `festival_activity_registration` VALUES (139, 8, 4, 'registered', '2026-03-07 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (140, 8, 5, 'registered', '2026-03-08 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (141, 8, 6, 'registered', '2026-03-09 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (142, 8, 7, 'registered', '2026-03-10 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (143, 8, 8, 'registered', '2026-03-11 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (144, 8, 9, 'registered', '2026-03-12 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (145, 8, 10, 'registered', '2026-03-13 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (146, 8, 22, 'registered', '2026-03-14 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (147, 8, 23, 'registered', '2026-03-15 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (148, 8, 24, 'registered', '2026-03-16 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (149, 8, 25, 'registered', '2026-03-17 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (150, 8, 26, 'registered', '2026-03-18 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (151, 8, 27, 'registered', '2026-03-19 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (152, 8, 28, 'registered', '2026-03-20 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (153, 8, 29, 'registered', '2026-03-21 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (154, 8, 30, 'registered', '2026-03-22 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (155, 8, 31, 'registered', '2026-03-23 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (156, 8, 32, 'registered', '2026-03-24 14:30:00');

-- 节庆活动9(成人礼仪式)的23条报名记录
INSERT INTO `festival_activity_registration` VALUES (157, 9, 4, 'registered', '2026-02-20 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (158, 9, 5, 'registered', '2026-02-21 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (159, 9, 6, 'registered', '2026-02-22 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (160, 9, 7, 'registered', '2026-02-23 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (161, 9, 8, 'registered', '2026-02-24 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (162, 9, 9, 'registered', '2026-02-25 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (163, 9, 10, 'registered', '2026-02-26 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (164, 9, 22, 'registered', '2026-02-27 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (165, 9, 23, 'registered', '2026-02-28 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (166, 9, 24, 'registered', '2026-03-01 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (167, 9, 25, 'registered', '2026-03-02 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (168, 9, 26, 'registered', '2026-03-03 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (169, 9, 27, 'registered', '2026-03-04 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (170, 9, 28, 'registered', '2026-03-05 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (171, 9, 29, 'registered', '2026-03-06 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (172, 9, 30, 'registered', '2026-03-07 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (173, 9, 31, 'registered', '2026-03-08 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (174, 9, 32, 'registered', '2026-03-09 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (175, 9, 33, 'registered', '2026-03-10 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (176, 9, 34, 'registered', '2026-03-11 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (177, 9, 35, 'registered', '2026-03-12 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (178, 9, 36, 'registered', '2026-03-13 11:45:00');
...
CREATE TABLE `exhibition`  (
  ...
  `title` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '展览标题',
  `organizer` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '组织者',
  `description` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '展览描述',
  `location` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '展览地点',
  `start_date` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '开始日期',
  `end_date` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '结束日期',
  `opening_hours` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '开放时间',
...
CREATE TABLE `lecture`  (
  ...
  `title` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '讲座标题',
  `speaker` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '讲师',
  ...
  `location` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '讲座地点',
  `start_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '开始时间',
  `end_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '结束时间',
...
CREATE TABLE `lecture_registration`  (
  ...
  `registration_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '预约时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 174 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '讲座预约表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of lecture_registration
-- ----------------------------
-- 讲座1(汉服的历史演变)的21条预约记录
...
-- 讲座2(汉服制作工艺)的19条预约记录
INSERT INTO `lecture_registration` VALUES (23, 2, 16, 'registered', '2026-03-15 09:00:00');
...
-- 讲座4(明代汉服的特点)的18条预约记录
INSERT INTO `lecture_registration` VALUES (67, 4, 11, 'registered', '2026-03-28 09:00:00');
...
-- 讲座6(唐代汉服与时尚)的21条预约记录
INSERT INTO `lecture_registration` VALUES (112, 6, 17, 'registered', '2026-04-08 09:00:00');
...
INSERT INTO `lecture_registration` VALUES (173, 7, 2, 'registered', '2026-04-05 10:00:00');

-- 讲座8(汉服的国际化发展)的22条预约记录
...
CREATE TABLE `shop`  (
  ...
  `name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '店铺名称',
  `description` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '店铺描述',
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '店铺图片URL',
  `address` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '地址',
...
-- ----------------------------
-- 店铺1 (汉服小铺) - 2张图片
INSERT INTO `shop_show` VALUES (1, 1, 'backend/uploads/shopshow/1-1.jpg');
INSERT INTO `shop_show` VALUES (2, 1, 'backend/uploads/shopshow/1-2.jpg');

-- 店铺2 (霓裳羽衣) - 4张图片
INSERT INTO `shop_show` VALUES (3, 2, 'backend/uploads/shopshow/2-1.jpg');
INSERT INTO `shop_show` VALUES (4, 2, 'backend/uploads/shopshow/2-2.jpg');
INSERT INTO `shop_show` VALUES (5, 2, 'backend/uploads/shopshow/2-3.jpg');
INSERT INTO `shop_show` VALUES (6, 2, 'backend/uploads/shopshow/2-4.jpg');

-- 店铺3 (汉风堂) - 5张图片
INSERT INTO `shop_show` VALUES (7, 3, 'backend/uploads/shopshow/3-1.jpg');
INSERT INTO `shop_show` VALUES (8, 3, 'backend/uploads/shopshow/3-2.jpg');
INSERT INTO `shop_show` VALUES (9, 3, 'backend/uploads/shopshow/3-3.jpg');
INSERT INTO `shop_show` VALUES (10, 3, 'backend/uploads/shopshow/3-4.jpg');
INSERT INTO `shop_show` VALUES (11, 3, 'backend/uploads/shopshow/3-5.jpg');

-- 店铺4 (华服小馆) - 3张图片
INSERT INTO `shop_show` VALUES (12, 4, 'backend/uploads/shopshow/4-1.jpg');
INSERT INTO `shop_show` VALUES (13, 4, 'backend/uploads/shopshow/4-2.jpg');
INSERT INTO `shop_show` VALUES (14, 4, 'backend/uploads/shopshow/4-3.jpg');

-- 店铺5 (汉服世家) - 3张图片
INSERT INTO `shop_show` VALUES (15, 5, 'backend/uploads/shopshow/5-1.jpg');
INSERT INTO `shop_show` VALUES (16, 5, 'backend/uploads/shopshow/5-2.jpg');
INSERT INTO `shop_show` VALUES (17, 5, 'backend/uploads/shopshow/5-3.jpg');

-- 店铺6 (雅韵汉服) - 3张图片
INSERT INTO `shop_show` VALUES (18, 6, 'backend/uploads/shopshow/6-1.jpg');
INSERT INTO `shop_show` VALUES (19, 6, 'backend/uploads/shopshow/6-2.jpg');
INSERT INTO `shop_show` VALUES (20, 6, 'backend/uploads/shopshow/6-3.jpg');

-- 店铺7 (汉唐华服) - 3张图片
INSERT INTO `shop_show` VALUES (21, 7, 'backend/uploads/shopshow/7-1.jpg');
INSERT INTO `shop_show` VALUES (22, 7, 'backend/uploads/shopshow/7-2.jpg');
INSERT INTO `shop_show` VALUES (23, 7, 'backend/uploads/shopshow/7-3.jpg');

-- 店铺8 (锦绣坊) - 3张图片
INSERT INTO `shop_show` VALUES (24, 8, 'backend/uploads/shopshow/8-1.jpg');
INSERT INTO `shop_show` VALUES (25, 8, 'backend/uploads/shopshow/8-2.jpg');
INSERT INTO `shop_show` VALUES (26, 8, 'backend/uploads/shopshow/8-3.jpg');

-- 店铺9 (古风雅韵) - 3张图片
INSERT INTO `shop_show` VALUES (27, 9, 'backend/uploads/shopshow/9-1.jpg');
INSERT INTO `shop_show` VALUES (28, 9, 'backend/uploads/shopshow/9-2.jpg');
INSERT INTO `shop_show` VALUES (29, 9, 'backend/uploads/shopshow/9-3.jpg');

-- 店铺10 (汉衣坊) - 3张图片
INSERT INTO `shop_show` VALUES (30, 10, 'backend/uploads/shopshow/10-1.jpg');
INSERT INTO `shop_show` VALUES (31, 10, 'backend/uploads/shopshow/10-2.jpg');
INSERT INTO `shop_show` VALUES (32, 10, 'backend/uploads/shopshow/10-3.jpg');

-- 店铺11 (华裳九州) - 3张图片
INSERT INTO `shop_show` VALUES (33, 11, 'backend/uploads/shopshow/11-1.jpg');
INSERT INTO `shop_show` VALUES (34, 11, 'backend/uploads/shopshow/11-2.jpg');
INSERT INTO `shop_show` VALUES (35, 11, 'backend/uploads/shopshow/11-3.jpg');

-- 店铺12 (礼乐衣冠) - 3张图片
INSERT INTO `shop_show` VALUES (36, 12, 'backend/uploads/shopshow/12-1.jpg');
INSERT INTO `shop_show` VALUES (37, 12, 'backend/uploads/shopshow/12-2.jpg');
INSERT INTO `shop_show` VALUES (38, 12, 'backend/uploads/shopshow/12-3.jpg');

-- 店铺13 (盛世华服) - 3张图片
INSERT INTO `shop_show` VALUES (39, 13, 'backend/uploads/shopshow/13-1.jpg');
INSERT INTO `shop_show` VALUES (40, 13, 'backend/uploads/shopshow/13-2.jpg');
INSERT INTO `shop_show` VALUES (41, 13, 'backend/uploads/shopshow/13-3.jpg');

-- 店铺14 (古风堂) - 3张图片
INSERT INTO `shop_show` VALUES (42, 14, 'backend/uploads/shopshow/14-1.jpg');
INSERT INTO `shop_show` VALUES (43, 14, 'backend/uploads/shopshow/14-2.jpg');
INSERT INTO `shop_show` VALUES (44, 14, 'backend/uploads/shopshow/14-3.jpg');

-- 店铺15 (皇家织造) - 5张图片
INSERT INTO `shop_show` VALUES (45, 15, 'backend/uploads/shopshow/15-1.jpg');
INSERT INTO `shop_show` VALUES (46, 15, 'backend/uploads/shopshow/15-2.jpg');
INSERT INTO `shop_show` VALUES (47, 15, 'backend/uploads/shopshow/15-3.jpg');
INSERT INTO `shop_show` VALUES (48, 15, 'backend/uploads/shopshow/15-4.jpg');
INSERT INTO `shop_show` VALUES (49, 15, 'backend/uploads/shopshow/15-5.jpg');

-- 店铺16 (御品华服) - 3张图片
INSERT INTO `shop_show` VALUES (50, 16, 'backend/uploads/shopshow/16-1.jpg');
INSERT INTO `shop_show` VALUES (51, 16, 'backend/uploads/shopshow/16-2.jpg');
INSERT INTO `shop_show` VALUES (52, 16, 'backend/uploads/shopshow/16-3.jpg');

-- 店铺17 (天衣无缝) - 3张图片
-- 先删除店铺17的旧数据（如果有重复主键）
DELETE FROM `shop_show` WHERE `id` IN (54, 55, 56) AND `shop_id` = 17;
INSERT INTO `shop_show` VALUES (53, 17, 'backend/uploads/shopshow/17-1.jpg');
INSERT INTO `shop_show` VALUES (54, 17, 'backend/uploads/shopshow/17-2.jpg');
INSERT INTO `shop_show` VALUES (55, 17, 'backend/uploads/shopshow/17-3.jpg');
...
CREATE TABLE `shop_review` (
  ...
  `shop_id` bigint(20) NOT NULL COMMENT '店铺ID',
  `user_id` bigint(20) NOT NULL COMMENT '用户ID',
  `rating` decimal(3, 1) NOT NULL COMMENT '评分(1-5)',
  `content` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '评价内容',
  ...
  `average_rating` decimal(3, 1) NOT NULL COMMENT '平均评分',
  `rating1` int(11) NOT NULL COMMENT '1星评价数',
  `rating2` int(11) NOT NULL COMMENT '2星评价数',
  `rating3` int(11) NOT NULL COMMENT '3星评价数',
  `rating4` int(11) NOT NULL COMMENT '4星评价数',
  `rating5` int(11) NOT NULL COMMENT '5星评价数',
  `review_count` int(11) NOT NULL COMMENT '评价总数',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `shop_id`(`shop_id` ASC) USING BTREE,
  INDEX `user_id`(`user_id` ASC) USING BTREE,
...
CREATE TABLE `post`  (
  ...
  `title` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '帖子标题',
  `content` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '帖子内容',
  `description` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '帖子简介',
  ...
  `publish_date` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '发布日期',
  PRIMARY KEY (`id`) USING BTREE,
