...
CREATE TABLE `shop`  (
  ...
  `mainBusiness` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '主营业务',
  `sort_order` int(11) NOT NULL DEFAULT 0 COMMENT '排序顺序',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `user_id`(`user_id` ASC) USING BTREE,
...
INSERT INTO `shop` VALUES (1, 3, '汉服小铺', '专注于平价汉服的店铺，款式多样，适合入门爱好者。我们提供各种风格的汉服，从日常穿着到节日庆典，满足不同场合的需求。所有汉服均采用优质面料，做工精细，让您在穿着舒适的同时展现传统文化之美。', 'backend/uploads/shop/1.jpg', '北京市朝阳区', '13800138001', '普通档（0-400）', '日常汉服、节日庆典汉服', 1);
INSERT INTO `shop` VALUES (7, 3, '汉唐华服', '中等价位的汉服店铺，做工精细。我们专注于将传统工艺与现代设计相结合，打造出既符合传统形制又适合现代穿着的汉服。每一件汉服都经过精心制作，从面料选择到细节处理，都体现了我们对品质的追求。', 'backend/uploads/shop/7.jpg', '北京市海淀区', '13800138007', '中档（400-700）', '传统工艺汉服、现代设计汉服', 2);

-- 商家2 (织云, id=44): 1个店铺 - 普通档
INSERT INTO `shop` VALUES (2, 44, '霓裳羽衣', '提供性价比高的汉服，适合日常穿着。我们的汉服设计简约大方，注重舒适度和实用性，让您在日常生活中也能轻松驾驭传统服饰。所有款式均经过精心挑选，确保质量和时尚感并存。', 'backend/uploads/shop/2.jpg', '上海市浦东新区', '13900139002', '普通档（0-400）', '日常汉服、简约风格汉服', 3);

-- 商家3 (衔花, id=45): 2个店铺 - 普通档+中档
INSERT INTO `shop` VALUES (3, 45, '汉风堂', '传统汉服店铺，价格亲民，款式经典。我们专注于传承经典汉服款式，每一件汉服都体现了传统工艺的精髓。我们的设计师深入研究历史文献，确保每一款汉服都符合传统形制，让您感受到真正的华夏衣冠之美。', 'backend/uploads/shop/3.jpg', '广州市天河区', '13700137003', '普通档（0-400）', '传统经典汉服、历史款式复刻', 4);
INSERT INTO `shop` VALUES (8, 45, '锦绣坊', '绣花精美的中档汉服店铺。我们以精美的绣花工艺著称，每一件汉服都装饰有精致的刺绣图案。我们的绣工师傅拥有多年经验，能够将各种传统图案栩栩如生地呈现在汉服上，让您的服饰更加独特和精美。', 'backend/uploads/shop/8.jpg', '上海市静安区', '13900139008', '中档（400-700）', '绣花汉服、精致工艺汉服', 5);

-- 商家4 (南风, id=46): 1个店铺 - 普通档
INSERT INTO `shop` VALUES (4, 46, '华服小馆', '小而精致的汉服店铺，主打平价款式。我们虽然规模不大，但致力于为顾客提供最精致的汉服体验。每一件汉服都经过精心挑选和质量检验，确保您能以实惠的价格购买到高品质的传统服饰。', 'backend/uploads/shop/4.jpg', '杭州市西湖区', '13600136004', '普通档（0-400）', '平价汉服、精致款式', 6);

-- 商家5 (锦瑟, id=47): 2个店铺 - 普通档+中档
INSERT INTO `shop` VALUES (5, 47, '汉服世家', '家族经营的汉服店铺，价格实惠。我们是一家有着多年历史的家族企业，传承了数代人的汉服制作工艺。我们的汉服不仅价格实惠，而且做工精细，每一件都凝聚了我们对传统文化的热爱和敬意。', 'backend/uploads/shop/5.jpg', '成都市锦江区', '13500135005', '普通档（0-400）', '传统工艺汉服、家族传承款式', 7);
INSERT INTO `shop` VALUES (9, 47, '古风雅韵', '主打古风设计的中档汉服店铺。我们专注于古风设计，将传统元素与现代审美相结合，打造出具有浓郁古风韵味的汉服。我们的设计师深入研究古代服饰文化，确保每一款汉服都能展现出古典的美感和现代的时尚。', 'backend/uploads/shop/9.jpg', '广州市越秀区', '13700137009', '中档（400-700）', '古风设计汉服、传统元素融合', 8);

-- 商家6 (枕霞, id=48): 2个店铺 - 普通档+中档
INSERT INTO `shop` VALUES (6, 48, '雅韵汉服', '优雅韵味的汉服店铺，价格适中。我们的汉服设计注重优雅的气质和传统的韵味，每一件都能展现出穿着者的古典美。我们选用优质面料，精心制作，让您在各种场合都能展现出独特的魅力。', 'backend/uploads/shop/6.jpg', '南京市玄武区', '13400134006', '普通档（0-400）', '优雅风格汉服、传统韵味款式', 9);
INSERT INTO `shop` VALUES (10, 48, '汉衣坊', '传统工艺制作的中档汉服店铺。我们坚持使用传统工艺制作汉服，每一件都经过精心的手工制作。我们的工匠师傅拥有丰富的经验，能够将传统工艺与现代需求相结合，打造出既传统又实用的汉服。', 'backend/uploads/shop/10.jpg', '深圳市南山区', '13600136010', '中档（400-700）', '传统工艺汉服、手工制作', 10);

-- 商家7 (听雨, id=49): 1个店铺 - 中高档
INSERT INTO `shop` VALUES (11, 49, '华裳九州', '中高端汉服品牌，设计独特。我们是一家专注于高端汉服设计的品牌，每一件汉服都由专业设计师精心设计，具有独特的风格和创意。我们选用高品质面料，结合传统工艺和现代设计，打造出既美观又舒适的高端汉服。', 'backend/uploads/shop/11.jpg', '北京市朝阳区', '13800138011', '中高档（700-1000）', '高端设计汉服、独特风格', 11);

-- 商家8 (裁月, id=50): 1个店铺 - 中高档
INSERT INTO `shop` VALUES (12, 50, '礼乐衣冠', '注重礼仪文化的中高端汉服店铺。我们专注于礼仪文化，提供符合传统礼仪规范的汉服。我们的汉服设计参考了大量历史文献和文物，确保每一件都符合传统礼仪要求，让您在各种礼仪场合都能展现出得体的形象。', 'backend/uploads/shop/12.jpg', '上海市黄浦区', '13900139012', '中高档（700-1000）', '礼仪场合汉服、传统规范款式', 12);

-- 商家9 (清商, id=51): 1个店铺 - 中高档
INSERT INTO `shop` VALUES (13, 51, '盛世华服', '重现盛世风采的中高端汉服品牌。我们致力于重现古代盛世的服饰风采，每一件汉服都参考了历史上的经典款式。我们的设计师深入研究各个朝代的服饰特点，结合现代工艺，打造出既具有历史感又适合现代穿着的高端汉服。', 'backend/uploads/shop/13.jpg', '杭州市余杭区', '13700137013', '中高档（700-1000）', '历史款式复刻、盛世风格汉服', 13);

-- 商家10 (栖霞, id=52): 1个店铺 - 中高档
INSERT INTO `shop` VALUES (14, 52, '古风堂', '古典风格的中高端汉服店铺。我们专注于古典风格的汉服设计，每一件都体现了传统服饰的精髓。我们的汉服采用传统工艺制作，面料选用高品质的丝绸和棉麻，确保穿着舒适且具有古典美感。', 'backend/uploads/shop/14.jpg', '苏州市姑苏区', '13600136014', '中高档（700-1000）', '古典风格汉服、高品质面料', 14);

-- 商家11 (拾花, id=53): 1个店铺 - 高档
INSERT INTO `shop` VALUES (15, 53, '皇家织造', '顶级汉服定制店铺，工艺精湛。我们是一家专注于高端汉服定制的店铺，拥有精湛的传统工艺和丰富的定制经验。每一件汉服都由资深工匠手工制作，从面料选择到细节处理，都体现了我们对品质的极致追求，为您打造独一无二的专属汉服。', 'backend/uploads/shop/15.jpg', '北京市西城区', '13800138015', '高档（1000以上）', '高端定制汉服、顶级工艺', 15);

-- 商家12 (云想, id=54): 1个店铺 - 高档
INSERT INTO `shop` VALUES (16, 54, '御品华服', '皇室风格的高档汉服品牌。我们专注于皇室风格的汉服设计，每一件都体现了皇家的尊贵与典雅。我们选用最优质的面料，采用传统工艺制作，为您打造出具有皇室风范的高端汉服，让您在各种场合都能展现出非凡的气质。', 'backend/uploads/shop/16.jpg', '上海市徐汇区', '13900139016', '高档（1000以上）', '皇室风格汉服、尊贵典雅款式', 16);

-- 商家13 (未央, id=55): 1个店铺 - 高档
INSERT INTO `shop` VALUES (17, 55, '天衣无缝', '顶级工艺的高档汉服定制店铺。我们以顶级工艺著称，每一件汉服都由经验丰富的工匠手工制作，确保每一个细节都完美无瑕。我们选用最优质的面料，结合传统工艺和现代技术，为您打造出独一无二的高端定制汉服，展现您的独特品味和气质。', 'backend/uploads/shop/17.jpg', '杭州市西湖区', '13700137017', '高档（1000以上）', '顶级定制汉服、完美工艺', 17);
