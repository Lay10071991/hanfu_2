...
CREATE TABLE `hanfu_display`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '汉服ID',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '汉服名称',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '汉服描述',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '详细内容',
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '图片URL',
  `sort_order` int NOT NULL DEFAULT 0 COMMENT '排序顺序',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '汉服展示表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of hanfu_display
-- ----------------------------
INSERT INTO `hanfu_display` VALUES (1, '战国袍', '战国时期的袍服，款式简洁大方，体现了当时的审美风格。', '战国袍是战国时期流行的袍服形制，款式简洁大方，通常为交领右衽，袖子宽大，长度及地。战国袍的面料多为丝绸、棉麻等，色彩以素色为主，装饰简洁。战国袍的穿着方式体现了当时的礼仪规范，是贵族和士大夫的常见服饰。', '/uploads/hanfu/1.jpg', 1, '2026-03-01 19:22:16', '2026-03-01 19:22:16');
INSERT INTO `hanfu_display` VALUES (2, '明制', '明代的汉服形制，款式严谨规范，体现了明代的礼仪文化。', '明制汉服是明代的汉服形制，包括袄裙、马面裙、直裰等多种款式。明制汉服的特点是款式严谨规范，色彩搭配和谐，装饰精美。明制汉服的穿着方式体现了明代的礼仪文化，是当时社会各阶层的常见服饰。', '/uploads/hanfu/2.jpg', 2, '2026-03-01 19:22:16', '2026-03-01 19:22:16');
INSERT INTO `hanfu_display` VALUES (3, '晋制', '晋代的汉服形制，款式洒脱飘逸，体现了魏晋风流的审美风格。', '晋制汉服是晋代的汉服形制，款式洒脱飘逸，通常为交领右衽，袖子宽大，衣裾宽松。晋制汉服的面料多为丝绸，色彩以素雅为主，装饰简洁。晋制汉服的穿着方式体现了魏晋风流的审美风格，是当时文人雅士的常见服饰。', '/uploads/hanfu/3.jpg', 3, '2026-03-01 19:22:16', '2026-03-01 19:22:16');
INSERT INTO `hanfu_display` VALUES (4, '宋制', '宋代的汉服形制，款式简洁质朴，体现了宋代的审美风格。', '宋制汉服是宋代的汉服形制，包括褙子、襦裙、圆领袍等多种款式。宋制汉服的特点是款式简洁质朴，色彩搭配和谐，装饰精美。宋制汉服的穿着方式体现了宋代的审美风格，是当时社会各阶层的常见服饰。', '/uploads/hanfu/4.jpg', 4, '2026-03-01 19:22:16', '2026-03-01 19:22:16');
INSERT INTO `hanfu_display` VALUES (5, '唐制', '唐代的汉服形制，款式开放多样，体现了唐代的开放包容精神。', '唐制汉服是唐代的汉服形制，包括衫裙、圆领袍、半臂等多种款式。唐制汉服的特点是款式开放多样，色彩斑斓，装饰精美。唐制汉服的穿着方式体现了唐代的开放包容精神，是当时社会各阶层的常见服饰。', '/uploads/hanfu/5.jpg', 5, '2026-03-01 19:22:16', '2026-03-01 19:22:16');
INSERT INTO `hanfu_display` VALUES (6, '齐腰襦裙', '齐腰襦裙是汉服中常见的女装形制，款式优雅大方。', '齐腰襦裙是汉服中常见的女装形制，由短上衣（襦）和齐腰裙子组成。齐腰襦裙的特点是款式优雅大方，色彩搭配和谐，装饰精美。齐腰襦裙的穿着方式体现了东方女性的优雅气质，是历代女性的常见服饰。', '/uploads/hanfu/6.jpg', 6, '2026-03-01 19:22:16', '2026-03-01 19:22:16');
INSERT INTO `hanfu_display` VALUES (7, '褙子裙', '褙子裙是宋代流行的女装形制，款式优雅大方。', '褙子裙是宋代流行的女装形制，由褙子和裙子组成。褙子是一种无袖或短袖的上衣，款式优雅大方，色彩搭配和谐，装饰精美。褙子裙的穿着方式体现了宋代女性的优雅气质，是当时女性的常见服饰。', '/uploads/hanfu/7.jpg', 7, '2026-03-01 19:22:16', '2026-03-01 19:22:16');
INSERT INTO `hanfu_display` VALUES (8, '圆领袍', '圆领袍是汉服中常见的男装形制，款式简洁大方。', '圆领袍是汉服中常见的男装形制，款式简洁大方，通常为圆领，袖子宽大，长度及地。圆领袍的面料多为丝绸、棉麻等，色彩以素色为主，装饰简洁。圆领袍的穿着方式体现了男性的阳刚之气，是历代男性的常见服饰。', '/uploads/hanfu/8.jpg', 8, '2026-03-01 19:22:16', '2026-03-01 19:22:16');
INSERT INTO `hanfu_display` VALUES (9, '飞鱼服', '飞鱼服是明代锦衣卫的官服，款式华丽威严。', '飞鱼服是明代锦衣卫的官服，款式华丽威严，通常为红色或紫色，绣有飞鱼纹样。飞鱼服的面料多为丝绸，装饰精美，体现了明代官服的等级制度。飞鱼服的穿着方式体现了锦衣卫的威严，是明代官员的特殊服饰。', '/uploads/hanfu/9.jpg', 9, '2026-03-01 19:22:16', '2026-03-01 19:22:16');
...
-- ----------------------------
INSERT INTO `etiquette` VALUES (1, '肃拜礼', '秦汉时期', 'worship', '/uploads/etiquette_posture/1.jpg', '秦汉时期的重要礼仪，用于正式场合的拜见，体现尊卑有序的礼制思想。行礼时身体微躬，双手合抱，神情庄重，动作缓慢而有力。', '体现尊卑有序的礼制思想|动作庄重缓慢|适用于正式场合|体现对长者和尊者的尊敬', '站立端正，双脚并拢|双手缓缓合抱于胸前|身体微躬，头略低|保持姿势片刻后缓缓起身', '行礼时要保持神情庄重，动作不宜过快，体现对对方的尊重。', '2026-03-01 19:22:16', '2026-03-01 19:33:54');
INSERT INTO `etiquette` VALUES (2, '颜首礼', '魏晋时期', 'worship', '/uploads/etiquette_posture/2.jpg', '魏晋名士风度的体现，行礼时注重仪态的自然与优雅。体现了当时文人雅士追求个性解放和自然之美的思想。', '体现名士风度|动作自然优雅|注重个人气质|融合道家思想', '自然站立，神情从容|头部微倾，目光温和|右手轻抚左胸|微笑示意，动作流畅', '行礼时要保持自然从容，避免刻意做作，体现文人雅士的风范。', '2026-03-01 19:22:16', '2026-03-01 19:33:54');
INSERT INTO `etiquette` VALUES (3, '叉手礼', '唐代', 'standing', '/uploads/etiquette_posture/3.jpg', '唐代流行的日常礼节，双手交叉于胸前，体现唐代的开放与包容。是当时社会各阶层通用的见面礼节。', '日常通用礼节|体现开放包容|动作简洁大方|适用于各种场合', '双手自然下垂|右手在上，左手在下交叉|双手置于胸前|微微点头示意', '此礼适用于平辈之间的日常问候，动作要自然流畅。', '2026-03-01 19:22:16', '2026-03-01 19:33:54');
INSERT INTO `etiquette` VALUES (4, '万福礼', '宋代', 'standing', '/uploads/etiquette_posture/4.jpg', '宋代女性常用礼仪，双手合抱于腰侧，微屈膝，体现女性的柔美。是古代女性见面的标准礼节。', '女性专用礼节|体现柔美气质|动作优雅含蓄|表达美好祝愿', '双手合抱于腰侧右侧|右腿稍向后撤|双膝微屈|口称"万福"', '行礼时要保持姿态优雅，动作轻柔，体现女性特有的温柔气质。', '2026-03-01 19:22:16', '2026-03-01 19:33:54');
INSERT INTO `etiquette` VALUES (5, '揖礼', '明代', 'standing', '/uploads/etiquette_posture/5.jpg', '明代通用的见面礼节，双手合抱鞠躬，体现明代礼仪的规范化。是当时社会交往中的基本礼节。', '通用见面礼节|体现礼仪规范化|动作简洁明了|表达相互尊重', '双手合抱于胸前|身体前倾鞠躬|保持姿势片刻|缓缓直身', '行礼时动作要规范，体现明代礼仪的庄重。', '2026-03-01 19:22:16', '2026-03-01 19:33:54');
INSERT INTO `etiquette` VALUES (6, '请安礼', '清代', 'standing', '/uploads/etiquette_posture/6.jpg', '清代流行的问候礼节，体现清代礼仪的等级制度。是清代社会各阶层通用的问候方式。', '清代通用问候礼节|体现等级制度|动作规范严格|表达敬意', '按照身份等级行礼|双手合抱或垂手|身体微躬|口称问候语', '行礼时要根据身份等级选择适当的礼节。', '2026-03-01 19:22:16', '2026-03-01 19:33:54');
INSERT INTO `etiquette` VALUES (7, '稽首礼', '周代', 'worship', '/uploads/etiquette_posture/7.jpg', '古代最隆重的跪拜礼，用于祭祀天地和拜见君王。是九拜中最重的礼节，表达极度的尊敬。', '最隆重的礼节|用于祭祀和朝见|表达极度尊敬|动作庄重规范', '跪地，双手伏地|头触地停留片刻|缓缓抬头|再拜一次', '此礼极为庄重，只在重要场合使用，动作要规范严谨。', '2026-03-01 19:22:16', '2026-03-01 19:33:54');
INSERT INTO `etiquette` VALUES (8, '顿首礼', '汉代', 'worship', '/uploads/etiquette_posture/8.jpg', '磕头礼，用于请罪或表达极度尊敬之情。动作较为急促，表达强烈的情感。', '表达强烈情感|用于请罪或极度尊敬|动作较为急促|头触地即起', '快速跪地|头触地即起|可连续多次|神情恳切', '此礼表达的情感较为强烈，要配合适当的神情和语气。', '2026-03-01 19:22:16', '2026-03-01 19:33:54');
INSERT INTO `etiquette` VALUES (9, '空首礼', '唐代', 'worship', '/uploads/etiquette_posture/9.jpg', '跪拜礼的一种，头不至地，用于地位相当者之间的礼节。比稽首礼稍轻，表达平等的尊重。', '地位相当者使用|头不至地|表达平等尊重|动作较为轻松', '跪地，双手拱合|头向前倾但不触地|保持姿势片刻|缓缓直身', '行礼时要注意头不能触地，体现平等的尊重关系。', '2026-03-01 19:22:16', '2026-03-01 19:33:54');
...
-- Records of festival
-- ----------------------------
INSERT INTO `festival` VALUES (1, '成人礼', '农历三月三', 'spring', '/uploads/festival_custom/1.jpg', '古代重要的成年仪式，男子二十岁行冠礼，女子十五岁行笄礼，标志正式成年，承担社会责任。', '加冠:男子二十岁时举行冠礼，加冠三次，象征成年，获得社会认可|及笄:女子十五岁时举行笄礼，将头发盘起，标志成年，可以婚嫁|取字:成年后取字，用于社交场合，体现文化修养', '2026-03-01 19:22:16', '2026-03-01 19:34:46');
INSERT INTO `festival` VALUES (2, '上元节', '农历正月十五', 'spring', '/uploads/festival_custom/2.jpg', '新年第一个月圆之夜，赏灯猜谜，祈求新的一年平安顺利。', '赏花灯:各地举办灯会，展示各种精美的花灯造型|猜灯谜:将谜语写在灯笼上，供人猜射，增添节日趣味|吃元宵:食用糯米制成的圆形食品，象征团圆美满', '2026-03-01 19:22:16', '2026-03-01 19:34:46');
INSERT INTO `festival` VALUES (3, '乞巧节', '农历七月初七', 'summer', '/uploads/festival_custom/3.jpg', '中国的情人节，源于牛郎织女的传说，女子乞巧祈福。', '乞巧:女子向织女星祈求智巧，提高女红技艺|观星:夜晚仰望星空，寻找牛郎织女星|祈福:祈求美好姻缘和幸福生活', '2026-03-01 19:22:16', '2026-03-01 19:34:46');
INSERT INTO `festival` VALUES (4, '清明节', '公历四月四-六日', 'spring', '/uploads/festival_custom/4.jpg', '祭祖扫墓，缅怀先人，同时也是踏青郊游的好时节。', '扫墓祭祖:清理祖先墓地，献上祭品，表达对先人的怀念|踏青郊游:春光明媚时节，外出游玩，感受大自然|放风筝:放飞风筝，寓意放走晦气，迎接好运', '2026-03-01 19:22:16', '2026-03-01 19:34:46');
INSERT INTO `festival` VALUES (5, '端午节', '农历五月初五', 'summer', '/uploads/festival_custom/5.jpg', '纪念屈原的节日，有赛龙舟、吃粽子的习俗，驱邪避疫。', '赛龙舟:多人划桨竞赛，纪念屈原投江，体现团结协作精神|吃粽子:用糯米包裹各种馅料，纪念屈原，也是时令美食|挂艾草:悬挂艾草和菖蒲，驱除蚊虫，净化空气', '2026-03-01 19:22:16', '2026-03-01 19:34:46');
INSERT INTO `festival` VALUES (6, '中秋节', '农历八月十五', 'autumn', '/uploads/festival_custom/6.jpg', '月圆人团圆，赏月吃月饼，寄托思念之情。', '赏月:家人团聚，欣赏圆月，寄托思念之情|吃月饼:食用圆形月饼，象征团圆美满|祭月:设香案祭拜月神，祈求平安吉祥', '2026-03-01 19:22:16', '2026-03-01 19:34:46');
INSERT INTO `festival` VALUES (7, '重阳节', '农历九月初九', 'autumn', '/uploads/festival_custom/7.jpg', '敬老爱老的节日，登高赏菊，祈求健康长寿。', '登高:登山远眺，锻炼身体，祈求避灾|赏菊:欣赏菊花，饮酒赋诗，陶冶情操|敬老:慰问老人，表达对长者的尊敬和关爱', '2026-03-01 19:22:16', '2026-03-01 19:34:46');
INSERT INTO `festival` VALUES (8, '冬至节', '公历十二月二十一-二十三日', 'winter', '/uploads/festival_custom/8.jpg', '一年中白昼最短的一天，北方吃饺子，南方吃汤圆。', '吃饺子:北方习俗，吃饺子寓意不冻耳朵|吃汤圆:南方习俗，吃汤圆象征团圆|祭祖:祭祀祖先，表达对先人的怀念', '2026-03-01 19:22:16', '2026-03-01 19:34:46');
INSERT INTO `festival` VALUES (9, '腊八节', '农历腊月初八', 'winter', '/uploads/festival_custom/9.jpg', '佛教节日，喝腊八粥，祈求平安吉祥。', '喝腊八粥:用多种食材熬制粥品，祈求五谷丰登|祭祀:祭祀祖先和神灵，祈求来年平安|施粥:向穷人施粥，体现慈悲心肠', '2026-03-01 19:22:16', '2026-03-01 19:34:46');
...
INSERT INTO `festival_activity_registration` VALUES (22, 2, 4, 'registered', '2026-03-25 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (23, 2, 5, 'registered', '2026-03-25 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (24, 2, 6, 'registered', '2026-03-25 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (25, 2, 7, 'registered', '2026-03-25 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (26, 2, 8, 'registered', '2026-03-26 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (27, 2, 9, 'registered', '2026-03-26 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (28, 2, 10, 'registered', '2026-03-26 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (29, 2, 22, 'registered', '2026-03-26 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (30, 2, 23, 'registered', '2026-03-26 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (31, 2, 24, 'registered', '2026-03-27 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (32, 2, 25, 'registered', '2026-03-27 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (33, 2, 26, 'registered', '2026-03-27 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (34, 2, 27, 'registered', '2026-03-27 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (35, 2, 28, 'registered', '2026-03-27 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (36, 2, 29, 'registered', '2026-03-28 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (37, 2, 30, 'registered', '2026-03-28 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (38, 2, 31, 'registered', '2026-03-28 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (39, 2, 32, 'registered', '2026-03-28 14:30:00');

-- 节庆活动3(端午龙舟竞渡)的24条报名记录，包含lay(id=2)
INSERT INTO `festival_activity_registration` VALUES (40, 3, 2, 'registered', '2026-06-01 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (41, 3, 4, 'registered', '2026-06-01 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (42, 3, 5, 'registered', '2026-06-01 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (43, 3, 6, 'registered', '2026-06-01 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (44, 3, 7, 'registered', '2026-06-01 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (45, 3, 8, 'registered', '2026-06-02 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (46, 3, 9, 'registered', '2026-06-02 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (47, 3, 10, 'registered', '2026-06-02 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (48, 3, 22, 'registered', '2026-06-02 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (49, 3, 23, 'registered', '2026-06-02 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (50, 3, 24, 'registered', '2026-06-03 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (51, 3, 25, 'registered', '2026-06-03 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (52, 3, 26, 'registered', '2026-06-03 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (53, 3, 27, 'registered', '2026-06-03 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (54, 3, 28, 'registered', '2026-06-03 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (55, 3, 29, 'registered', '2026-06-04 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (56, 3, 30, 'registered', '2026-06-04 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (57, 3, 31, 'registered', '2026-06-04 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (58, 3, 32, 'registered', '2026-06-04 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (59, 3, 33, 'registered', '2026-06-04 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (60, 3, 34, 'registered', '2026-06-05 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (61, 3, 35, 'registered', '2026-06-05 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (62, 3, 36, 'registered', '2026-06-05 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (63, 3, 37, 'registered', '2026-06-05 14:00:00');

-- 节庆活动4(七夕乞巧大会)的22条报名记录
INSERT INTO `festival_activity_registration` VALUES (64, 4, 4, 'registered', '2026-08-01 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (65, 4, 5, 'registered', '2026-08-01 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (66, 4, 6, 'registered', '2026-08-01 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (67, 4, 7, 'registered', '2026-08-01 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (68, 4, 8, 'registered', '2026-08-02 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (69, 4, 9, 'registered', '2026-08-02 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (70, 4, 10, 'registered', '2026-08-02 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (71, 4, 22, 'registered', '2026-08-02 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (72, 4, 23, 'registered', '2026-08-02 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (73, 4, 24, 'registered', '2026-08-03 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (74, 4, 25, 'registered', '2026-08-03 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (75, 4, 26, 'registered', '2026-08-03 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (76, 4, 27, 'registered', '2026-08-03 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (77, 4, 28, 'registered', '2026-08-03 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (78, 4, 29, 'registered', '2026-08-04 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (79, 4, 30, 'registered', '2026-08-04 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (80, 4, 31, 'registered', '2026-08-04 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (81, 4, 32, 'registered', '2026-08-04 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (82, 4, 33, 'registered', '2026-08-04 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (83, 4, 34, 'registered', '2026-08-05 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (84, 4, 35, 'registered', '2026-08-05 10:30:00');

-- 节庆活动5(中秋赏月诗会)的20条报名记录，包含lay(id=2)
INSERT INTO `festival_activity_registration` VALUES (85, 5, 2, 'registered', '2026-09-10 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (86, 5, 4, 'registered', '2026-09-10 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (87, 5, 5, 'registered', '2026-09-10 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (88, 5, 6, 'registered', '2026-09-10 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (89, 5, 7, 'registered', '2026-09-10 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (90, 5, 8, 'registered', '2026-09-11 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (91, 5, 9, 'registered', '2026-09-11 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (92, 5, 10, 'registered', '2026-09-11 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (93, 5, 22, 'registered', '2026-09-11 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (94, 5, 23, 'registered', '2026-09-11 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (95, 5, 24, 'registered', '2026-09-12 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (96, 5, 25, 'registered', '2026-09-12 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (97, 5, 26, 'registered', '2026-09-12 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (98, 5, 27, 'registered', '2026-09-12 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (99, 5, 28, 'registered', '2026-09-12 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (100, 5, 29, 'registered', '2026-09-13 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (101, 5, 30, 'registered', '2026-09-13 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (102, 5, 31, 'registered', '2026-09-13 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (103, 5, 32, 'registered', '2026-09-13 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (104, 5, 33, 'registered', '2026-09-13 16:00:00');

-- 节庆活动6(重阳登高敬老)的18条报名记录
INSERT INTO `festival_activity_registration` VALUES (105, 6, 4, 'registered', '2026-10-01 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (106, 6, 5, 'registered', '2026-10-01 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (107, 6, 6, 'registered', '2026-10-01 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (108, 6, 7, 'registered', '2026-10-01 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (109, 6, 8, 'registered', '2026-10-02 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (110, 6, 9, 'registered', '2026-10-02 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (111, 6, 10, 'registered', '2026-10-02 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (112, 6, 22, 'registered', '2026-10-02 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (113, 6, 23, 'registered', '2026-10-02 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (114, 6, 24, 'registered', '2026-10-03 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (115, 6, 25, 'registered', '2026-10-03 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (116, 6, 26, 'registered', '2026-10-03 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (117, 6, 27, 'registered', '2026-10-03 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (118, 6, 28, 'registered', '2026-10-03 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (119, 6, 29, 'registered', '2026-10-04 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (120, 6, 30, 'registered', '2026-10-04 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (121, 6, 31, 'registered', '2026-10-04 12:00:00');

-- 节庆活动7(冬至饺子宴)的17条报名记录
INSERT INTO `festival_activity_registration` VALUES (122, 7, 4, 'registered', '2026-12-10 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (123, 7, 5, 'registered', '2026-12-10 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (124, 7, 6, 'registered', '2026-12-10 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (125, 7, 7, 'registered', '2026-12-10 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (126, 7, 8, 'registered', '2026-12-10 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (127, 7, 9, 'registered', '2026-12-11 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (128, 7, 10, 'registered', '2026-12-11 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (129, 7, 22, 'registered', '2026-12-11 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (130, 7, 23, 'registered', '2026-12-11 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (131, 7, 24, 'registered', '2026-12-11 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (132, 7, 25, 'registered', '2026-12-12 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (133, 7, 26, 'registered', '2026-12-12 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (134, 7, 27, 'registered', '2026-12-12 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (135, 7, 28, 'registered', '2026-12-12 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (136, 7, 29, 'registered', '2026-12-12 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (137, 7, 30, 'registered', '2026-12-13 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (138, 7, 31, 'registered', '2026-12-13 10:45:00');

-- 节庆活动8(腊八施粥祈福)的19条报名记录
INSERT INTO `festival_activity_registration` VALUES (139, 8, 4, 'registered', '2027-01-05 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (140, 8, 5, 'registered', '2027-01-05 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (141, 8, 6, 'registered', '2027-01-05 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (142, 8, 7, 'registered', '2027-01-05 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (143, 8, 8, 'registered', '2027-01-06 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (144, 8, 9, 'registered', '2027-01-06 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (145, 8, 10, 'registered', '2027-01-06 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (146, 8, 22, 'registered', '2027-01-06 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (147, 8, 23, 'registered', '2027-01-06 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (148, 8, 24, 'registered', '2027-01-07 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (149, 8, 25, 'registered', '2027-01-07 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (150, 8, 26, 'registered', '2027-01-07 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (151, 8, 27, 'registered', '2027-01-07 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (152, 8, 28, 'registered', '2027-01-07 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (153, 8, 29, 'registered', '2027-01-08 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (154, 8, 30, 'registered', '2027-01-08 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (155, 8, 31, 'registered', '2027-01-08 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (156, 8, 32, 'registered', '2027-01-08 14:30:00');

-- 节庆活动9(成人礼仪式)的23条报名记录
INSERT INTO `festival_activity_registration` VALUES (157, 9, 4, 'registered', '2026-03-10 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (158, 9, 5, 'registered', '2026-03-10 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (159, 9, 6, 'registered', '2026-03-10 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (160, 9, 7, 'registered', '2026-03-10 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (161, 9, 8, 'registered', '2026-03-11 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (162, 9, 9, 'registered', '2026-03-11 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (163, 9, 10, 'registered', '2026-03-11 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (164, 9, 22, 'registered', '2026-03-11 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (165, 9, 23, 'registered', '2026-03-11 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (166, 9, 24, 'registered', '2026-03-12 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (167, 9, 25, 'registered', '2026-03-12 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (168, 9, 26, 'registered', '2026-03-12 11:45:00');
INSERT INTO `festival_activity_registration` VALUES (169, 9, 27, 'registered', '2026-03-12 14:00:00');
INSERT INTO `festival_activity_registration` VALUES (170, 9, 28, 'registered', '2026-03-12 15:30:00');
INSERT INTO `festival_activity_registration` VALUES (171, 9, 29, 'registered', '2026-03-13 09:15:00');
INSERT INTO `festival_activity_registration` VALUES (172, 9, 30, 'registered', '2026-03-13 10:45:00');
INSERT INTO `festival_activity_registration` VALUES (173, 9, 31, 'registered', '2026-03-13 12:00:00');
INSERT INTO `festival_activity_registration` VALUES (174, 9, 32, 'registered', '2026-03-13 14:30:00');
INSERT INTO `festival_activity_registration` VALUES (175, 9, 33, 'registered', '2026-03-13 16:00:00');
INSERT INTO `festival_activity_registration` VALUES (176, 9, 34, 'registered', '2026-03-14 09:00:00');
INSERT INTO `festival_activity_registration` VALUES (177, 9, 35, 'registered', '2026-03-14 10:30:00');
INSERT INTO `festival_activity_registration` VALUES (178, 9, 36, 'registered', '2026-03-14 11:45:00');
...
-- ----------------------------
INSERT INTO `exhibition` VALUES (1, '千年汉服文化展', '中国汉服协会', '展示从先秦到明清的汉服实物和复制品，呈现汉服的历史演变和文化内涵。', '北京国家博物馆', '2026-03-15', '2026-04-15', '09:00-17:00 (周一闭馆)', 50.00, '/uploads/exhibition/1.jpg', '1. 请提前预约参观时间\n2. 保持安静，勿触摸展品\n3. 禁止使用闪光灯拍照\n4. 遵守展馆各项规定', '汇集了从先秦到明清的珍贵汉服实物，包括宫廷御用服饰和民间日常服装，展现汉服的完整历史演变脉络', '2026-03-14 10:00:00', '2026-03-14 10:00:00');
...
-- Records of lecture
-- ----------------------------
INSERT INTO `lecture` VALUES (1, '汉服的历史演变', '张教授', '历史学博士，专注于中国古代服饰史研究，出版《汉服史话》等多部学术著作，在汉服文化研究领域享有盛誉。', '详细介绍汉服从先秦到明清的历史演变过程，探讨不同朝代汉服的特点和文化内涵。', '本讲座将从汉服的起源讲起，详细介绍先秦时期的深衣、汉代的袍服、唐代的幞头襕衫、宋代的褙子、明代的补服等不同时期的代表性服饰，分析其款式、色彩、纹样的变化，以及背后的社会文化因素。通过大量历史图片和实物资料，展现汉服发展的完整脉络。', '北京文化中心', '2026-03-20 14:00:00', '2026-03-20 16:00:00', 100, 35, '请提前15分钟到场签到\n讲座期间请保持安静\n可携带笔记本记录\n讲座结束后设有互动问答环节', '/uploads/talk/1.jpg', '2026-03-14 10:00:00', '2026-03-14 10:00:00');
INSERT INTO `lecture` VALUES (2, '汉服制作工艺', '李师傅', '国家级非物质文化遗产传承人，从事传统汉服制作40余年，擅长各种传统缝制工艺，培养了众多汉服制作人才。', '讲解传统汉服的制作工艺和技巧，包括面料选择、裁剪方法和缝制技术。', '本讲座将详细介绍汉服制作的完整流程，从面料的选择与处理开始，讲解传统汉服的裁剪方法、缝制技巧、装饰工艺等。李师傅将现场展示传统针法和刺绣技巧，并分享多年积累的制作经验，让参与者了解汉服制作的精髓所在。', '上海手工艺中心', '2026-03-25 10:00:00', '2026-03-25 12:00:00', 80, 28, '请提前10分钟到场\n现场将有互动制作环节\n可携带小型工具\n听从现场工作人员安排', '/uploads/talk/2.jpg', '2026-03-14 10:00:00', '2026-03-14 10:00:00');
INSERT INTO `lecture` VALUES (3, '汉服与传统礼仪', '王教授', '礼仪学专家，研究中国传统礼仪文化30余年，著有《中国传统礼仪大全》等著作，经常受邀参加国内外文化交流活动。', '探讨汉服与传统礼仪的关系，介绍不同场合的汉服穿着规范和礼仪要求。', '本讲座将深入探讨汉服与传统礼仪的紧密关系，详细介绍不同场合（如婚礼、祭祀、朝会等）的汉服穿着规范和礼仪要求。王教授将通过生动的案例和现场演示，讲解汉服穿着的礼仪细节，以及如何在现代社会中恰当运用传统礼仪。', '西安大唐芙蓉园', '2026-04-02 14:00:00', '2026-04-02 16:00:00', 120, 45, '请提前20分钟到场\n讲座期间将有礼仪演示\n建议穿着舒适服装\n保持手机静音', '/uploads/talk/3.jpg', '2026-03-14 10:00:00', '2026-03-14 10:00:00');
INSERT INTO `lecture` VALUES (4, '明代汉服的特点', '刘博士', '明史专家，专注于明代服饰研究，主持多项国家级研究课题，发表学术论文数十篇，对明代汉服有深入研究。', '深入解析明代汉服的款式、纹样和穿着特点，展示明代服饰的独特魅力。', '本讲座将聚焦明代汉服的独特特点，详细解析明代官服的补子制度、常服的款式变化、女子服饰的多样风格等。刘博士将结合南京博物馆的馆藏文物，分析明代汉服的面料、色彩、纹样特点，以及其背后的社会等级制度和文化内涵。', '南京博物馆', '2026-04-10 09:30:00', '2026-04-10 11:30:00', 90, 32, '请提前15分钟到场签到\n讲座期间有实物展示\n禁止触摸展品\n遵守博物馆相关规定', '/uploads/talk/4.jpg', '2026-03-14 10:00:00', '2026-03-14 10:00:00');
INSERT INTO `lecture` VALUES (5, '汉服复兴运动', '陈老师', '汉服文化推广者，参与组织多次大型汉服文化活动，撰写《汉服复兴之路》等著作，致力于汉服文化的现代传承。', '讲述现代汉服复兴运动的发展历程，分析其文化意义和社会影响。', '本讲座将系统梳理现代汉服复兴运动的发展历程，从早期的民间自发活动到如今的规模化文化现象。陈老师将分享自己参与组织的大型汉服活动经验，分析汉服复兴对当代社会的文化意义，以及如何在现代生活中更好地传承和发展汉服文化。', '杭州西湖文化广场', '2026-05-10 15:00:00', '2026-05-10 17:00:00', 150, 68, '请提前10分钟到场\n讲座结束后有交流环节\n可携带汉服相关问题\n保持会场整洁', '/uploads/talk/5.jpg', '2026-03-14 10:00:00', '2026-03-14 10:00:00');
INSERT INTO `lecture` VALUES (6, '唐代汉服与时尚', '赵教授', '服装史专家，研究唐代服饰文化20余年，曾参与多个唐代服饰复原项目，对唐代时尚文化有独特见解。', '探讨唐代汉服的时尚元素和设计特点，分析其对现代时尚的影响。', '本讲座将深入探讨唐代汉服的时尚元素，详细分析唐代女子的襦裙、男子的幞头袍衫等代表性服饰的设计特点。赵教授将结合唐代壁画、陶俑等资料，展示唐代服饰的色彩搭配、纹样设计和配饰风格，并分析其对现代时尚设计的影响和启发。', '洛阳龙门石窟', '2026-05-15 14:00:00', '2026-05-15 16:00:00', 100, 42, '请提前15分钟到场\n讲座期间有唐代服饰展示\n可拍照但禁止闪光灯\n遵守景区相关规定', '/uploads/talk/6.jpg', '2026-03-14 10:00:00', '2026-03-14 10:00:00');
INSERT INTO `lecture` VALUES (7, '汉服与文学艺术', '钱老师', '文学博士，研究中国古代文学与服饰文化的关系，发表多篇相关学术论文，对汉服在文学作品中的表现有深入研究。', '分析汉服在文学、绘画等艺术形式中的表现，探讨其文化象征意义。', '本讲座将从文学艺术的角度解读汉服文化，通过分析《诗经》、唐诗宋词等文学作品中对汉服的描写，以及绘画、壁画中汉服的视觉表现，探讨汉服在艺术作品中的文化象征意义。钱老师将通过经典文学片段的朗诵和赏析，展现汉服与文学艺术的紧密联系。', '苏州园林', '2026-06-05 10:00:00', '2026-06-05 12:00:00', 80, 25, '请提前10分钟到场\n讲座期间有文学作品朗诵\n保持安静聆听\n遵守园林参观规定', '/uploads/talk/7.jpg', '2026-03-14 10:00:00', '2026-03-14 10:00:00');
INSERT INTO `lecture` VALUES (8, '汉服的国际化发展', '孙博士', '文化传播学专家，研究中国传统文化的国际传播，曾在多个国际学术会议上发表关于汉服国际化的演讲。', '探讨汉服在国际舞台上的传播和发展，分析其作为文化符号的意义。', '本讲座将探讨汉服在国际舞台上的传播与发展历程，分析汉服如何从传统服饰转变为具有全球影响力的文化符号。孙博士将分享汉服在国际时尚界、文化交流活动中的表现，以及海外汉服社团的发展状况，探讨如何进一步推动汉服的国际化传播。', '广州文化中心', '2026-06-15 15:00:00', '2026-06-15 17:00:00', 120, 50, '请提前15分钟到场\n讲座期间有国际汉服展示\n鼓励提问交流\n保持会场秩序', '/uploads/talk/8.jpg', '2026-03-14 10:00:00', '2026-03-14 10:00:00');
...
INSERT INTO `shop` VALUES (7, 3, '汉唐华服', '中等价位的汉服店铺，做工精细。我们专注于将传统工艺与现代设计相结合，打造出既符合传统形制又适合现代穿着的汉服。每一件汉服都经过精心制作，从面料选择到细节处理，都体现了我们对品质的追求。', 'https://cdn.jsdelivr.net/gh/Hanerdev/Image-Hosting@main/hanfu/shop7.webp', '北京市海淀区', '13800138007', '中档（400-700）', '2026-01-07 10:00:00', '2026-01-07 10:00:00');
